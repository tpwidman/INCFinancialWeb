...
export default class HowitworksViewControl extends BaseViewControl {
    templateString: string = require('./howitworks.vc.html');
...
register.viewControl('howitworks-vc', HowitworksViewControl);
